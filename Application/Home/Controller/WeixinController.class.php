...
//输出图片
	...
	public function setMenu(){
     ...
     "button":[
     {
          "type":"view",
          "name":"进入首页",
          "url":"http://test.junruihang.com/index.php/index/index"
      },
      {
           "name":"个人中心",
           "sub_button":[
           {
               "type":"view",
               "name":"佣金提现",
               "url":"http://test.junruihang.com/index.php/Center/mymoney.html"
            },
            {
                 "type":"view",
                 "name":"会员注册",
                 "url":"http://test.junruihang.com/index.php/Login/regin_1",

             },
            {
               "type":"view",
               "name":"会员登录",
               "key":"http://test.junruihang.com/index.php/Login/index.html"
            }]
       },
       {
           "name":"关于平台",
           "sub_button":[
           {
               "type":"view",
               "name":"联系客服",
               "url":"http://test.junruihang.com/index.php/Center/kefu.html"
            },
            {
                 "type":"view",
                 "name":"平台协议",
                 "url":"http://test.junruihang.com/index.php/Index/pingtai.html",

             },
            {
               "type":"view",
               "name":"平台介绍",
               "key":"http://test.junruihang.com/index.php/Center/xy.html"
            }]
       }]
 }';
		$result = curl_request($url, $params, 'POST');
