    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="row row-lg">
                <div class="col-sm-12">
                    <div id="toolbar">
                        <?php if(display_menu('/admin/Agent/addAgentRate')){ ?>
                           <!-- <a class="btn btn-success" data-toggle="modal" data-target="#addCustomer" data-remote="/admin/Agent/addAgentRate" >
                                新增
                            </a>-->
                        ...
                        <?php } ?>
                        <?php if(display_menu('/admin/Agent/editAgentRate')){ ?>
                            <button id="edit" class="btn btn-primary" disabled>
                                编辑
                            </button>
                        <?php } ?>
                        <?php if(display_menu('/admin/Agent/delAgentRate')){ ?>
                    ...
                    <table id="table"
                           ...
                           data-url="/Admin/Agent/loadAgentRate"
    ...
    <script type="text/javascript">
        ...
        function initTable() {
            $table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'RateName',title: '返点名称', align: 'center'},
                        {field: 'Rate', title: '返点类型', align: 'center'},
                        {field: 'Amount', title: '返点金额', align: 'center'},
                        {field: 'Commission', title: '佣金类型', align: 'center'},
            ...
            $remove.click(function () {
                ...
                var param = {ids:ids};
                confirmDelete("/admin/Agent/delAgentRate",param,$table,$remove,"RateID",ids);
            });
            $add.click(function(){
                $("#addCustomer").modal({
                    remote: "/admin/Agent/addAgentRate"
                    ,backdrop: 'static'
                    ,keyboard: false
                });
            });
            $edit.click(function(){
                $("#addCustomer").modal({
                    remote: "/admin/Agent/editAgentRate?id=" + getIdSelections()+'&t=' + Math.random(1000)
                    ,backdrop: 'static'
                    ,keyboard: false
                });
            });
