    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="row row-lg">
                <div class="col-sm-12">
                    <div id="toolbar">
                        <?php if(display_menu('/admin/Employee/addDepartment')){ ?>
                            <a class="btn btn-success" data-toggle="modal" data-target="#addCustomer" data-remote="/admin/Employee/addDepartment" >
                                新增
                            </a>
                        <?php } ?>
                        <?php if(display_menu('/admin/Employee/editDepartment')){ ?>
                            <button id="edit" class="btn btn-primary" disabled>
                                编辑
                            </button>
                        <?php } ?>
                        <?php if(display_menu('/admin/Employee/delDepartment')){ ?>
                    ...
                    <table id="table"
                           ...
                           data-url="/admin/Employee/loadDepartment"
    ...
    <script type="text/javascript">
        ...
        function initTable() {
            $table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'DepartmentNum', title: '部门编号', align: 'center'},
            ...
            $remove.click(function () {
                ...
                var param = {ids:ids};
                confirmDelete("/admin/Employee/delDepartment",param,$table,$remove,"DepartmentID",ids);
            });
            $edit.click(function(){
                $("#addCustomer").modal({
                    remote: "/admin/Employee/editDepartment?id=" + getIdSelections()+'&t=' + Math.random(1000)
                });
            });
