    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="row row-lg">
                <div class="col-sm-12">
                    <div id="toolbar">
                        <?php if(display_menu('/admin/Product/addProduct')){ ?>
                            <a class="btn btn-success" data-toggle="modal" data-target="#addCustomer" data-remote="/admin/Product/addProduct" >
                                新增
                            </a>
                        <?php } ?>
                        <?php if(display_menu('/admin/Product/editProduct')){ ?>
                            <button id="edit" class="btn btn-primary" disabled>
                                编辑
                            </button>
                        <?php } ?>
                        <?php if(display_menu('/admin/Product/delProduct')){ ?>
                    ...
                    <table id="table"
                           ...
                           data-url="/admin/Product/loadProduct"
    ...
    <script type="text/javascript">
        ...
        function initTable() {
            ...
            $remove.click(function () {
                ...
                var param = {ids:ids};
                confirmDelete("/admin/Product/delProduct",param,$table,$remove,"ProductID",ids);
            });
            $edit.click(function(){
                $("#addCustomer").modal({
                    remote: "/admin/Product/editProduct?id=" + getIdSelections()+'&t=' + Math.random(1000)
                });
            });
