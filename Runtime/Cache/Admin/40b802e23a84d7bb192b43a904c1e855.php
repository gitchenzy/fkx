    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="row row-lg">
                <div class="col-sm-12">
                    <div id="toolbar">
                        <?php if(display_menu('/admin/Config/addOpen')){ ?>
                            <a class="btn btn-success" data-toggle="modal" data-target="#addCustomer" data-remote="/admin/Config/addOpen" >
                                新增
                            </a>
                        <?php } ?>
                        <?php if(display_menu('/admin/Config/editOpen')){ ?>
                            <button id="edit" class="btn btn-primary" disabled>
                                编辑
                            </button>
                        <?php } ?>
                        <?php if(display_menu('/admin/Config/delOpen')){ ?>
                    ...
                    <table id="table"
                           ...
                           data-url="/admin/Config/loadOpen"
    ...
    <script type="text/javascript">
        ...
        function initTable() {
            $table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'Value',title: '通知邮箱', align: 'center'},
            ...
            $remove.click(function () {
                ...
                var param = {ids:ids};
                confirmDelete("/admin/Config/delOpen",param,$table,$remove,"id",ids);
            });
            $edit.click(function(){
                $("#addCustomer").modal({
                    remote: "/admin/Config/editOpen?id=" + getIdSelections()+'&t=' + Math.random(1000)
                });
            });
