    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="row row-lg">
                <div class="col-sm-12">
                    <div id="toolbar">
                        <?php if(display_menu('/admin/Customer/addPayType')){ ?>
                            <a class="btn btn-success" data-toggle="modal" data-target="#addCustomer" data-remote="/admin/Customer/addPayType" >
                                新增
                            </a>
                        <?php } ?>
                        <?php if(display_menu('/admin/Customer/editPayType')){ ?>
                            <button id="edit" class="btn btn-primary" disabled>
                                编辑
                            </button>
                        <?php } ?>
                        <?php if(display_menu('/admin/Customer/delPayType')){ ?>
                    ...
                    <table id="table"
                           ...
                           data-url="/admin/Customer/loadPayType"
    ...
    <script type="text/javascript">
        ...
        function initTable() {
            $table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'PayName',title: '支付名称', align: 'center'},
                        {field: 'TypeName', title: '支付类型', align: 'center'},
                        {field: 'AccountNum', title: '收款账号', align: 'center'},
                        {field: 'OperatorName', title: '操作人', align: 'center',sortable: true,},
            ...
            $table.on('check.bs.table uncheck.bs.table ' +
                ...
                if(checkLen == 1){
                  //  $edit.attr("href","/admin/Customer/editPayType?id="+getIdSelections());
            ...
            $remove.click(function () {
                ...
                var param = {ids:ids};
                confirmDelete("/admin/Customer/delPayType",param,$table,$remove,"PayID",ids);
            });
            $edit.click(function(){
                $("#addCustomer").modal({
                    remote: "/admin/Customer/editPayType?id=" + getIdSelections()+'&t=' + Math.random(1000)
                });
            });
