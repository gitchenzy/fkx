    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="row row-lg">
                <div class="col-sm-12">
                    <div id="toolbar">
                        <?php if(display_menu('/admin/Employee/addMenu')){ ?>
                            <a class="btn btn-success" data-toggle="modal" data-target="#addCustomer" data-remote="/admin/Employee/addMenu" >
                                新增
                            </a>
                        <?php } ?>
                        <?php if(display_menu('/admin/Employee/editMenu')){ ?>
                            <button id="edit" class="btn btn-primary" disabled>
                                编辑
                            </button>
                        <?php } ?>
                        <?php if(display_menu('/admin/Employee/delMenu')){ ?>
                    ...
                    <table id="table"
                           ...
                           data-url="/admin/Employee/loadMenu"
    ...
    <script type="text/javascript">
        ...
        function initTable() {
            ...
            $remove.click(function () {
                ...
                var param = {ids:ids};
                confirmDelete("/admin/Employee/delMenu",param,$table,$remove,"ID",ids);
            });
            $edit.click(function(){
                $("#addCustomer").modal({
                    remote: "/admin/Employee/editMenu?id=" + getIdSelections()+'&t=' + Math.random(1000)
                });
            });
