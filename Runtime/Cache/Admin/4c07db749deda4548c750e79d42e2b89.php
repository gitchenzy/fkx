...
<div class="modal-body">
    <form class="form-horizontal" role="form" id="defaultForm" method="post" action="<?php echo ($self); ?>">
        <input type="hidden" name="id" value="<?php echo ($info["DepartmentID"]); ?>" />
        <fieldset>
            <div class="form-group">
                <label class="col-sm-2 control-label" for="DepartmentName">部门名称</label>
                <div class="col-sm-4">
                    <input class="form-control" id="DepartmentName" name="DepartmentName" type="text" value="<?php echo ($info["DepartmentName"]); ?>"/>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label" for="DepartmentNum">部门编号</label>
                <div class="col-sm-4">
                    <input class="form-control" id="DepartmentNum" name="DepartmentNum" type="text" value="<?php echo ($info["DepartmentNum"]); ?>"/>
                </div>
            </div>
            <div class="form-group">
