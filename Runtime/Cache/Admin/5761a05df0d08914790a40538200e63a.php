<?php if (!defined('THINK_PATH')) exit();?><div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel">指派实施人</h4>
</div>
<div class="modal-body">
    <form class="form-horizontal" role="form" id="defaultForm" method="post" action="<?php echo ($self); ?>">
        <input type="hidden" value="<?php echo ($_GET['SOPID']); ?>" name="SOPID">
        <fieldset>
            <div class="form-group">
                <label class="col-sm-2 control-label">客户</label>
                <div class="col-sm-3" style="position:relative;z-index:999;">

                    <input class="form-control" disabled value="<?php echo ($data["ShortName"]); ?>" type="text" />
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    ...
                    <?php echo parse_dropdownlist('',$info,"ForceID","ForceID","form-control","请选择指派人");?>

                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">实施天数</label>
                <div class="col-sm-3" style="position:relative;z-index:999;">

                    <input class="form-control" name="ConditionTime" value="<?php echo ($data["ConditionTime"]); ?>" type="text" />
