            ...
            <div class="row row-lg">
                <div class="col-sm-12">
                    <div id="toolbar">
                        ...
                        <?php if(display_menu('/admin/Maintain/editMainSop')){ ?>
                            <button id="edit" class="btn btn-primary" disabled>
                                申请实施
                            </button>
                        <?php } ?>
                        <?php if(display_menu('/admin/Maintain/appointSop')){ ?>
                        <button id="see" class="btn btn-primary" disabled>
                            指派
                        </button>
                        <?php } ?>
                        <?php if(display_menu('/admin/Maintain/confirmSop')){ ?>
                        <button id="confirm" class="btn btn-primary" disabled>
                            确认实施
                        </button>
                        <?php } ?>
                        <?php if(display_menu('/admin/Maintain/seeMainSop')){ ?>
