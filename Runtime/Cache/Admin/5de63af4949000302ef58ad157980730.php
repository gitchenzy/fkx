...
<div class="modal-body">
    <form class="form-horizontal" role="form" id="defaultForm" method="post" action="<?php echo ($self); ?>">
        <input type="hidden" name="id" value="<?php echo ($info["CtmStatusID"]); ?>" />
        <fieldset>
            <div class="form-group">
                <label class="col-sm-2 control-label" for="CtmStatusName">状态名称</label>
                <div class="col-sm-4">
                    <input class="form-control" id="CtmStatusName" name="CtmStatusName" type="text" value="<?php echo ($info["CtmStatusName"]); ?>"/>
                </div>
            </div>
