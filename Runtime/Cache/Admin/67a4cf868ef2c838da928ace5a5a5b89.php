<?php if (!defined('THINK_PATH')) exit();?><div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel"><?php if(empty($_GET['id'])): ?>新增<?php else: ?> 编辑<?php endif; ?>配置系统通知</h4>
</div>
<div class="modal-body">
    <form class="form-horizontal" role="form" id="defaultForm" method="post" action="<?php echo ($self); ?>">
        ...
        <fieldset>
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label" for="Value">通知邮箱</label>
                <div class="col-sm-4">
                    <input class="form-control" id="Value" name="Value" type="text" value="<?php echo ($info["Value"]); ?>"/>
                </div>
            </div>
