<?php if (!defined('THINK_PATH')) exit();?><div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel"><?php if(empty($_GET['id'])): ?>新增<?php else: ?> 编辑<?php endif; ?>产品</h4>
</div>
<div class="modal-body">
    <form class="form-horizontal" role="form" id="defaultForm" method="post" action="<?php echo ($self); ?>">
        <input type="hidden" name="id" value="<?php echo ($info["ProductID"]); ?>" />
        <fieldset>

            <div class="form-group">
                <label class="col-sm-2 control-label" for="ProductName">产品名称</label>
                <div class="col-sm-4">
                    <input class="form-control" id="ProductName" name="ProductName"  value="<?php echo ($info["ProductName"]); ?>" type="text" />
                </div>
