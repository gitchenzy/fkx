<?php if (!defined('THINK_PATH')) exit();?><div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel"><?php if(empty($_GET['id'])): ?>新增<?php else: ?> 编辑<?php endif; ?>亲密程度</h4>
</div>
    ...
    <form class="form-horizontal" role="form" id="defaultForm" method="post" action="<?php echo ($self); ?>">
        ...
        <fieldset>
            <div class="form-group">
                <label class="col-sm-2 control-label" for="CtmCloseName">亲密程度名称</label>
                <div class="col-sm-4">
                    <input class="form-control" id="CtmCloseName" name="CtmCloseName" type="text" value="<?php echo ($info["CtmCloseName"]); ?>"/>
                </div>
            </div>
