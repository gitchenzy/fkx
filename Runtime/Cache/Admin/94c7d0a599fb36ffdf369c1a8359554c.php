            ...
            <div class="select">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <input name="txtusername" type="text" id="LoginName" class="l_text css3bg" title="账号" value="账号" onfocus="if(this.value=='账号'){this.value='';}" onblur="if(this.value==''){this.value='账号';}" style="border: none">
                        </td>
                    </tr>
                    <tr>
                        <td width="24%" height="48" align="center">
                        ...
                        <td colspan="2">
                            <input name="txtpwd" type="password" id="Password" value="txtpwd" class="l_text" title="请输入密码" onfocus="if(this.value=='txtpwd'){this.value='';}" onblur="if(this.value==''){this.value='txtpwd';}" style="border: none">
                            <p>
                                <label id="msgpwd">
                                </label>
                            </p>
                    ...
                    <tr>
                        ...
                        <td width="28%">
                            <div class="yz_img left">
                                <img id="validImg" align="absMiddle" src="/verify.php?Tue Dec 22 2015 15:43:29 GMT+0800 (中国标准时间)" alt="验证码"></a></div>
                        </td>
                    </tr>
                    <tr>
