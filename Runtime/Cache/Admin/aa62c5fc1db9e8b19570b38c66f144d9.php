    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="row row-lg">
                <div class="col-sm-12">
                    <div id="toolbar">
                        <?php if(display_menu('/admin/Customer/addCustomerStatus')){ ?>
                            <a class="btn btn-success" data-toggle="modal" data-target="#addCustomer" data-remote="/admin/Customer/addCustomerStatus" >
                                新增
                            </a>
                        <?php } ?>
                        <?php if(display_menu('/admin/Customer/editCustomerStatus')){ ?>
                            <button id="edit" class="btn btn-primary" disabled>
                                编辑
                            </button>
                        <?php } ?>
                        <?php if(display_menu('/admin/Customer/delCtmStatus')){ ?>
                    ...
                    <table id="table"
                           ...
                           data-url="/admin/Customer/loadCustomerStatus"
    ...
    <script type="text/javascript">
        ...
        function initTable() {
            $table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'CtmStatusID',title: '状态编号', align: 'center'},
                        {field: 'CtmStatusName',title: '状态名称', align: 'center'},
            ...
            $remove.click(function () {
                ...
                var param = {ids:ids};
                confirmDelete("/admin/Customer/delCtmStatus",param,$table,$remove,"CtmStatusID",ids);
            });
            $edit.click(function(){
                $("#addCustomer").modal({
                    remote: "/admin/Customer/editCustomerStatus?id=" + getIdSelections()+'&t=' + Math.random(1000)
                });
            });
