    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="row row-lg">
                <div class="col-sm-12">
                    <div id="toolbar">
                        <?php if(display_menu('/admin/Market/addContractType')){ ?>
                            <a class="btn btn-success" data-toggle="modal" data-target="#addCustomer" data-remote="/admin/Market/addContractType" >
                                新增
                            </a>
                        <?php } ?>
                        <?php if(display_menu('/admin/Market/editContractType')){ ?>
                            <button id="edit" class="btn btn-primary" disabled>
                                编辑
                            </button>
                        <?php } ?>
                        <?php if(display_menu('/admin/Market/delContractType')){ ?>
                    ...
                    <table id="table"
                           ...
                           data-url="/admin/Market/loadContractType"
    ...
    <script type="text/javascript">
        ...
        function initTable() {
            $table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'CttTypeName',title: '类型名称', align: 'center'},
            ...
            $remove.click(function () {
                ...
                var param = {ids:ids};
                confirmDelete("/admin/Market/delContractType",param,$table,$remove,"CttTypeID",ids);
            });
            $edit.click(function(){
                $("#addCustomer").modal({
                    remote: "/admin/Market/editContractType?id=" + getIdSelections()+'&t=' + Math.random(1000)
                });
            });
