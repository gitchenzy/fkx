...
<div class="modal-body">
    <form class="form-horizontal" role="form" id="defaultForm" method="post" action="<?php echo ($self); ?>">
        <fieldset>
            ...
            <?php if(($CustomerID) != "3"): ?><div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    ...
                    <textarea id="Description" name="Description" style="width: 99.9%; height: 260px;"><?php if(empty($_GET['id'])): ?>操作步骤：<br> <br>存在问题：<br> <br>建议：<?php else: echo (htmlspecialchars_decode($info["Description"])); endif; ?></textarea>
                </div>
