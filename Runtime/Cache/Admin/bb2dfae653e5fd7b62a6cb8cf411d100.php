        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    ...
                    <input class="form-control" id="Identifier" disabled  value="<?php echo ($info["ShortName"]); ?>" type="text" />
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    ...
                    <input class="form-control" id="Contact"disabled value="<?php echo ($info["Contact"]); ?>" type="text" />
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">电话</label>
                <div class="col-sm-3">
                    <input class="form-control" id="Mobile" disabled  value="<?php echo ($info["Mobile"]); ?>" type="text" />
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">地址</label>
                <div class="col-sm-3">
                    <input class="form-control" id="Address" disabled  value="<?php echo ($info["Address"]); ?>" type="text" />
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">实施售前时间</label>
                <div class="col-sm-3">
                    <input class="form-control" id="SupportTime" disabled value="<?php echo ($info["SupportTime"]); ?>" type="text" />
                </div>
            </div>
            <div class="form-group">
