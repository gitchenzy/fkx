<?php if (!defined('THINK_PATH')) exit();?><div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel"><?php if(empty($_GET['id'])): ?>新增<?php else: ?> 编辑<?php endif; ?>角色关系</h4>
</div>
<div class="modal-body">
    <form class="form-horizontal" role="form" id="defaultForm" method="post" action="<?php echo ($self); ?>">
        <input type="hidden" name="id" value="<?php echo ($info["CtmRoleID"]); ?>" />
        <fieldset>
            <div class="form-group">
                <label class="col-sm-2 control-label" for="CtmRoleName">关系名称</label>
                <div class="col-sm-4">
                    <input class="form-control" id="CtmRoleName" name="CtmRoleName" type="text" value="<?php echo ($info["CtmRoleName"]); ?>"/>
                </div>
            </div>
