<?php if (!defined('THINK_PATH')) exit();?><div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel"> 需求受理</h4>
</div>
    ...
    <form class="form-horizontal" role="form" id="defaultForm" method="post" action="<?php echo ($self); ?>">
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input name="Accept" value="1" type="radio" />不受理
                    <input name="Accept" value="2" type="radio" />受理
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <span style="color:red;"> 如果需求不采用的话，请选择不受理</span>
                </div>
            </div>
