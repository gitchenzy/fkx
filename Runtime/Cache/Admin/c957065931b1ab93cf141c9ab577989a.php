    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="row row-lg">
                <div class="col-sm-12">
                    <div id="toolbar">
                        <?php if(display_menu('/admin/Agent/addAgentRule')){ ?>
                        <!--<a class="btn btn-success" data-toggle="modal" data-target="#addCustomer" data-remote="/admin/Agent/addAgentRule" >
                            新增
                        </a>-->
                        ...
                        <?php } ?>
                        <?php if(display_menu('/admin/Agent/editAgentRule')){ ?>
                        <button id="edit" class="btn btn-primary" disabled>
                            编辑
                        </button>
                        <?php } ?>
                        <?php if(display_menu('/admin/Agent/delAgentRule')){ ?>
                    ...
                    <table id="table"
                           ...
                           data-url="/Admin/Agent/loadAgentRule"
    ...
    <script type="text/javascript">
        ...
        function initTable() {
            $table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'typeName', title: '规则类型', align: 'center'},
                        {field: 'Rule', title: '规则条件', align: 'center'},
            ...
            $remove.click(function () {
                ...
                var param = {ids:ids};
                confirmDelete("/admin/Agent/delAgentRule",param,$table,$remove,"RuleID",ids);
            });
            $add.click(function(){
                $("#addCustomer").modal({
                    remote: "/admin/Agent/addAgentRule"
                    ,backdrop: 'static'
                    ,keyboard: false
                });
            });
            $edit.click(function(){
                $("#addCustomer").modal({
                    remote: "/admin/Agent/editAgentRule?id=" + getIdSelections()+'&t=' + Math.random(1000)
                    ,backdrop: 'static'
                    ,keyboard: false
                });
            });
