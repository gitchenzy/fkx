    ...
    <form class="form-main" id="form-main" action="">
        ...
        <table class="form-table" border="0">
            <tr>
                <th>部门名称</th>
                <td>
                    <input class="form-control" name="DepartmentName" value="<?php echo ($Info["DepartmentName"]); ?>" style="width:120px;">
                </td>
            ...
            <tr>
                <th>部门编号</th>
                <td>
                    <input class="form-control" name="DepartmentNum" value="<?php echo ($Info["DepartmentNum"]); ?>" style="width:120px;">
                </td>
