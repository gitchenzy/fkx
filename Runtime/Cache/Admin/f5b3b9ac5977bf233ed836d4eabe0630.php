        ...
        <table class="form-table" border="0">
            <tr>
                ...
                <td>
                    ...
                    <input type="radio" name="FBtype" <?php if($info['FBtype'] == 2): ?>checked<?php endif; ?> value="2">系统漏洞
                </td>
            ...
            <?php if(empty($CustomerID)): ?><tr>
                    ...
                    <td>
                        <select name="CustomerID" class="form-control">
                            <?php if(is_array($cInfo)): $i = 0; $__LIST__ = $cInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$c): $mod = ($i % 2 );++$i;?><option <?php if($info['CustomerID'] == $c['CustomerID']): ?>selected<?php endif; ?> value="<?php echo ($c["CustomerID"]); ?>">
                                <?php echo ($c["FullName"]); ?>
            ...
            <tr>
                <th>问题标题</th>
                <td>
                    <input class="form-control" value="<?php echo ($info["Title"]); ?>" name="Title" style="width:120px;">
            ...
            <tr>
                ...
                <td>
                    <select name="FbPriority" class="form-control">
                        <?php if(is_array($Priority)): $i = 0; $__LIST__ = $Priority;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$f): $mod = ($i % 2 );++$i;?><option value="<?php echo ($f["FbPriorityID"]); ?>" <?php if($info['FbPriority'] == $f['FbPriorityID']): ?>selected<?php endif; ?> >
            ...
            <tr>
                <th>问题备注</th>
                <td>
                    <input class="form-control" name="Note" value="<?php echo ($info["Note"]); ?>" style="width:240px;">
                </td>
            </tr>
            <tr>
                <th>解决状态</th>
                <td>
                    <?php echo ($info["stateName"]); ?>
                </td>
            </tr>
            <tr>
                <th>计划解决时间</th>
                <td>
                    <?php echo ($info["PlanTime"]); ?>
                </td>
            </tr>
            <tr>
                <th>实际解决时间</th>
                <td>
                    <?php echo ($info["SolveTime"]); ?>
                </td>
            </tr>
            <tr>
                <th>解决人</th>
                <td>
                    <?php echo ($info["EmpName"]); ?>
                </td>
            </tr>
        </table>
    </form>
