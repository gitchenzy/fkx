    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="row row-lg">
                <div class="col-sm-12">
                    <div id="toolbar">
                        <?php if(display_menu('/admin/Customer/addDemandState')){ ?>
                            <a class="btn btn-success" data-toggle="modal" data-target="#addCustomer" data-remote="/admin/Customer/addDemandState" >
                                新增
                            </a>
                        <?php } ?>
                        <?php if(display_menu('/admin/Customer/editDemandState')){ ?>
                            <button id="edit" class="btn btn-primary" disabled>
                                编辑
                            </button>
                        <?php } ?>
                        <?php if(display_menu('/admin/Customer/delDemandState')){ ?>
                    ...
                    <table id="table"
                           ...
                           data-url="/admin/Customer/loadDemandState"
    ...
    <script type="text/javascript">
        ...
        function initTable() {
            $table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'FbStatusName',title: '状态名称', align: 'center'},
            ...
            $remove.click(function () {
                ...
                var param = {ids:ids};
                confirmDelete("/admin/Customer/delDemandState",param,$table,$remove,"FbStatusID",ids);
            });
            $edit.click(function(){
                $("#addCustomer").modal({
                    remote: "/admin/Customer/editDemandState?id=" + getIdSelections()+'&t=' + Math.random(1000)
                });
            });
